...
Route::middleware(['auth'])->prefix('admin')->as('admin.')->group(function () {
    ...
    // Booking
    Route::namespace('Booking')->as('booking.')->prefix('booking')->controller(BookingController::class)->group(function () {
        Route::get('/doctor-list/{uuid}', 'doctorList')->name('doctor.list');
        Route::get('/clinic-list', 'clinicList')->name('clinic.list');
        Route::get('/slot/{clinicid}/{doctorid}', 'slotList')->name('booking.slot');
    });
});

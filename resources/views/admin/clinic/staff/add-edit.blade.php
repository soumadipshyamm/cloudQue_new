            ...
            <form action="{{ route('admin.clinic.staff.add') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 adfilter-single">
                        ...
                        @enderror --}}
                        <input type="text" class="form-control" value="{{ auth()->user()->clinicUser->first()->clinic_name }}" disabled>
                    ...
                    <div class="col-md-4 adfilter-single">
                        ...
                        <input type="number" class="form-control" name="alternative_mobile_no" id="alternative_mobile_no"
                            placeholder="Enter Staff Alternative Phone Number"
                            value="{{ old('alternative_mobile_no', $data->alternative_mobile_no ?? '') }}">

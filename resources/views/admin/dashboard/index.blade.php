        ...
        @if (auth()->user()->hasRole('super-admin', 'clinic'))
            <div class="stats_box row">
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="statsb_single">
                        <div class="statright_box">
                            <img src="{{ asset('assets/images/statistical_clinicsicon.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="statsb_single">
                        <div class="statright_box">
                            <img src="{{ asset('assets/images/mingcute_user-icon.png') }}" class="img-fluid"
                                alt="" />
                        </div>
                        <div class="statmain_box">
                            <h3>Patients</h3>
                            ...
                            <tbody>
                                @forelse ($clinicUser as $clinic)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="table-con"><span>{{ $clinic?->clinicUser[0]['email'] ?? '' }}</span>
                                            </p>
                                        </td>
                                        <td class="brk_line">
                                            <p class="table-con">
                            ...
                            <tbody>
                                @forelse ($doctorUser as $doctor)
                                    <tr>
                                        ...
                                        <td>
                                            <p class="table-con">
                                                <span>{{ $doctor?->doctorProfile?->registration_number }}</span>
                                            </p>
                                        </td>
                                        <td>
                                            <p class="table-con">
                                                <span>{{ $doctor?->doctorProfile?->category?->name }}</span>
                                            </p>
                                        </td>
                                        <td>
                                            <p class="table-con"><span>{{ $doctor?->doctorProfile?->qualifaction }}</span>
                                            </p>
                                        </td>
                                        <td>
                                            <div class="actionbox">
                                ...
                                @forelse ($patientUser as $patient)
                                    <tr>
                                        <td>
                                            <div class="companyn_box">
                                                <div class="companyb_img">
                                                    <img src="assets/images/company1.png" class="img-fluid"
                                                        alt="" />
                                                    <p class="table-con">

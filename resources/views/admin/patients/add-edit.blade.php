                ...
                <div class="row">
                    ...
                    <div class="col-md-4 adfilter-single">
                        ...
                        <input type="number" class="form-control" name="alternative_mobile_no" id="alternative_mobile_no"
                            placeholder="Ent Doctor Alternative Phone Number" value="{{ old('alternative_mobile_no',$isPatient->alternative_mobile_no??'') }}">
                    ...
                    <div class="col-md-4 adfilter-single">
                        ...
                        <input type="date" class="form-control" name="dob" id="dob" value="{{ old('dob',$isPatient->patientProfile?->dob??'') }}">
                        @error('dob')
                            <span class="invalid-feedback d-block" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>

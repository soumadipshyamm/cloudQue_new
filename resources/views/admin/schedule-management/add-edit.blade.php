                    ...
                    <div class="row">
                        ...
                        @else
                            <div class="col-md-4 adfilter-single">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ auth()->user()->clinicUser->first()->clinic_name }}" disabled>
                                <input type="hidden" name="clinicId" id="clinicId"
                                    value="{{ auth()->user()->clinicUser->first()->id }}">
                            </div>
                        @endif
                        ...
                        @else
                            <div class="col-md-4 adfilter-single">
                                <label for="doctorId">Doctor </label>
                                <input type="text" class="form-control"
                                    value="{{ auth()->user()->first()->name }}" disabled>
                            ...
                            <div class="col-md-10 timing_sec" data-key={{ $key }}>
                                <div class="row timing_row">
                                    ...
                                    <div class="col-md-4 break_sec">
                                        <div class="break-time-dsgn break_flex">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", ".add_break", function() {
                ...
                $(this).closest(".break_sec").append(`<div class="break-time-dsgn break_flex">
                                        <div class="adfilter-single">
            ...
            function generateFieldHtml(name, value, key, length, day) {
                return `<div class="row timing_row">
                        ...
                        <div class="col-md-1">
                            <a href="javascript:void(0)" class="remove-input-field"> <i class="fa fa-trash"></i></a>
                        </div>
                    </div>`
            }
        });

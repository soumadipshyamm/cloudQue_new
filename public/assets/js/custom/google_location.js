...
function latlngToLocation(latitude, longitude, isHeader = false) {
    jQuery.get(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${latitude},${longitude}&sensor=true&key=AIzaSyBrRtkwvBcSh3_uISG8CVAX2IqykHdQEP4`, function (data) {
        // console.log(data);
        const place = data.results[0];
        console.log(place.address_components);
        const formatted_address = place.formatted_address ? place.formatted_address : '';
        let address = '';
        let pincode = '';
        let city = '';
        let state = '';
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res == 'ok') {
                ...
                swal("Service currently not available in this location", "", "error");
            } else {
...
// <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBrRtkwvBcSh3_uISG8CVAX2IqykHdQEP4&amp;libraries=places&amp;callback=initAutocomplete" async="" defer=""></script>
